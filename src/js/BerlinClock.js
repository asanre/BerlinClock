var BerlinClock = { 
    ...
    reset: function(){
        var berlinContainer = document.getElementById("berlinClock")

        for (var i = 0; i < berlinContainer.children.length; i++) {    
            for (var j = 0; j < berlinContainer.children[i].children.length; j++) {
                berlinContainer.children[i].children[j].classList.remove("yellow");
                berlinContainer.children[i].children[j].classList.remove("red");
            }
        };
